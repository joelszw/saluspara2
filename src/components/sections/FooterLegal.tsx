      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <h3 className="font-bold text-xl mb-3">Salustia</h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:info@salustia.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  info@salustia.com
                </a>
              </li>
            </ul>
          ...
          {/* Social */}
          <div>
            <h4 className="font-bold text-sm mb-4">Síguenos</h4>
